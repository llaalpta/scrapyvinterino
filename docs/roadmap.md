...
| 14.3 | not-started | Atomic initial scheduler admission | `docs/specs/008-scheduler.md` | Branch `fix/scheduler-initial-admission`; serialize concurrent starts and make activation, session, deadline and initial run atomic. No external traffic. |
