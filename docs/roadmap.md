...
| 13 | in-progress | Producer-Consumer + DataDome bypass | `docs/specs/010-producer-consumer-bypass.md` | Chrome 120 direct runtime verified; residential/sticky proxy validation still pending before `done`. |
