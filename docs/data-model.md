...
- `monitor_sessions`: periodos historicos de lanzamiento de un monitor. El baseline de inicio manual no pertenece a una sesion; tras su exito se abre una fila que poseen todos los `Ejecutar ahora` posteriores hasta parada o fail-stop. Las sesiones recurrentes quedan abiertas hasta parada, expiracion o fallo.
