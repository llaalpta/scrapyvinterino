...
- PWA:
  - tabbed Opportunities, Monitors, and Settings views;
...
- Dashboard navigation exposes Opportunities, Monitors, and Settings; Activity is not a separate top-level view.
